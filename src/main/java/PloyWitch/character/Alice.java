package PloyWitch.character;

import PloyWitch.cards.*;
import PloyWitch.relics.Did;
...
import static PloyWitch.BasicMod.characterPath;
import static PloyWitch.BasicMod.makeID;

public class Alice extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("Alice"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass Witch;
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new Alice(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
    ...
    public Alice() {
        ...
        initializeClass(characterPath("Alice.png"), //The image to use. The rest of the initializeClass call is unchanged.
                SHOULDER_2,
                SHOULDER_1,
                CORPSE,
                getLoadout(),
                -0.0F, 0.0F, 200.0F, 250.0F, //Character hitbox. x y position, then width and height.
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        retVal.add(Defend.ID);
        retVal.add(Defend.ID);
        retVal.add(Circuts.ID);
        retVal.add(DiddleDiddleCard.ID);
        retVal.add(TheGreatThree.ID);
    ...
    public List<CutscenePanel> getCutscenePanels() {
        ...
        panels.add(new CutscenePanel(
                characterPath("cutscene/scene1.png"),
                "MAGICAL_GIRL_TRANSFORM"
        ));

        panels.add(new CutscenePanel(
                characterPath("cutscene/scene2.png")
        ));

        panels.add(new CutscenePanel(
                characterPath("cutscene/scene3.png")
        ));
